<?php
// Version: Inmortal 1.0 Beta; ManageScheduledTasks
...
$txt['scheduled_tasks_time_offset'] = '<strong>Nota:</strong> Todos los tiempos dados a continuación son <em>tiempos de servidor</em> y no tienen en cuenta ninguna configuración de offset que se haya establecido en Inmortal.';
...
$txt['scheduled_task_fetchSMfiles'] = 'Obtener archivos de K Dev Team';
