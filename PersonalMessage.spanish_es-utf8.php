<?php
// Version: Inmortal 1.0 Beta; PersonalMessage

global $context;

// Things for the popup
$txt['pm_unread'] = 'No leídos';
$txt['pm_sent_short'] = 'Enviados';
$txt['pm_new_short'] = 'Nuevos';
$txt['pm_drafts_short'] = 'Borradores';
$txt['pm_settings_short'] = 'Configuración';
$txt['pm_no_unread'] = 'Ningún mensaje sin leer';
$txt['pm_was_sent_to_you'] = 'Has recibido un mensaje.';
...
$txt['pm_prune_warning'] = '¿Estás seguro que deseas purgar tus mensajes privados?¡No podrán ser recuperados!';
$txt['pm_remove_all'] = 'Borrar todos tus mensajes personales (esto limpiará completamente tus bandejas de entrada y de salida).';
$txt['pm_remove_all_warning'] = '¿Estás completamente seguro/a de que quieres borrar todos tus mensajes personales? ¡No podrán ser recuperados!';
...
$txt['pm_rule_too_complex'] = 'La regla que estás creando es demasiado larga para guardarla en Inmortal. Intenta trocearla en reglas más pequeñas.';
