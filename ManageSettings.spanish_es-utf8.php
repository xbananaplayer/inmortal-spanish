...
$txt['setting_time_offset_note'] = '(Añadido a la opción específica del usuario)';
$txt['setting_default_timezone'] = 'Zona horaria del servidor';
$txt['failed_login_threshold'] = 'Umbral de conexiones fallidas';
$txt['loginHistoryDays'] = 'Días para mantener el historial de inicio de sesión';
...
$txt['error_log_desc'] = 'El registro de errores, si está habilitado, registrará cada error encontrado los usuarios que utilizan su foro. Esto puede ser una ayuda muy valiosa para la identificación de problemas foro.';
...
$txt['globalCookiesDomain'] = 'Dominio principal utilizado para cookies independientes del subdominio';
$txt['invalid_cookie_domain'] = 'El dominio introducido parece invalido, por favor compruébalo y guarda de nuevo.';
...
$txt['httponlyCookies'] = 'Forzar cookies a ser accesibles tan solo por protocolo HTTP';
$txt['securityDisable'] = 'Desactivar la seguridad de la administración';
$txt['securityDisable_moderate'] = 'Deshabilitar seguridad de moderación';
...
$txt['enable_ajax_alerts'] = 'Permitr Notificaciones para alertas de escritorio AJAX';
$txt['jquery_source'] = 'Fuente para jQuery Library';
$txt['jquery_custom_label'] = 'Personalizado';
$txt['jquery_custom'] = 'URL personalizada para jQuery Library';
...
$txt['settings_error'] = 'Advertencia: La actualización de Settings.php ha fallado, los ajustes no pueden guardarse.';
$txt['image_proxy_enabled'] = 'Habilitar Image Proxy';
$txt['image_proxy_secret'] = 'Image Proxy Secret';
$txt['image_proxy_maxsize'] = 'Tamaño máximo de archivos para imagen de caché (en KB)';
$txt['force_ssl'] = 'Foro en modo SSL';
$txt['force_ssl_off'] = 'Deshabilitar SSL';
$txt['force_ssl_auth'] = 'Habilitar SSL para autenticación (Inicio de sesión y Registro)';
$txt['force_ssl_complete'] = 'Forcar SSL por todo el foro';

// Like settings.
$txt['enable_likes'] = 'Habilitar Me gustas';

// Mention settings.
$txt['enable_mentions'] = 'Habilitar menciones';
...
$txt['detected_accelerators'] = '<strong class="success">Inmortal ha detectado los siguientes aceleradores: %1$s</strong>';
...
$txt['cache_accelerator'] = 'Acelerador de caché';
$txt['default_cache'] = 'Almacenamiento en caché basado en archivos Inmortal';
$txt['apc_cache'] = 'APC';
...
$txt['loadavg_userstats'] = 'Umbral para desactivar mostrar las estadísticas de usuarios';
$txt['loadavg_bbc'] = 'Umbral para desactivar el formato BBC al mostrar mensajes';
...
$txt['setting_enable_password_conversion'] = 'Permitir la conversión hash de contraseña';
...
$txt['question_not_defined'] = 'Usted necesita agregar una pregunta y respuesta para su lenguaje por defecto del forum\'s (%1$s) de lo contrario los usuarios no podrán rellenar un CAPTCHA, lo que significa que no se registrarán.';
...
$txt['setting_warning_watch_note'] = 'Nivel de advertencia del usuario después de que se le ponga vigilancia.';
...
$txt['setting_warning_moderate_note'] = 'Nivel de advertencia del usuario después de que tenga todos los posts moderados.';
...
$txt['setting_warning_mute_note'] = 'Nivel de advertencia del usuario después de que no pueda publicar más.';
...
$txt['setting_user_limit_note'] = 'Este valor es la máxima cantidad de puntos de alerta que un solo moderador puede asignar a un usuario en un periodo de 24 horas - 0 para ningún límite.';
...
$txt['setting_warning_decrement_note'] = 'Sólo aplicar a usuarios no advertidos en las últimas 24 horas.';
...
$txt['setting_warning_show_note'] = 'Determina quien puede ver el nivel de advertencia de los usuarios del foro.';
...
$txt['signature_settings_applied'] = 'Las normas actualizadas se han aplicado a las firmas existentes.';
...
$txt['signature_max_images_note'] = '(0 para ilimitados - emoticonos excluidos)';
$txt['signature_allow_smileys'] = 'Permitir emoticonos en las firmas';
...
$txt['custom_profile_fieldorder'] = 'Orden de campos';
...
$txt['custom_edit_placement_with_icons'] = 'Con emoticonos';
$txt['custom_edit_placement_above_signature'] = 'Sobre la firma';
$txt['custom_profile_placement'] = 'Colocación';
$txt['custom_profile_placement_standard'] = 'Estándar';
$txt['custom_profile_placement_with_icons'] = 'Con emoticonos';
$txt['custom_profile_placement_above_signature'] = 'Sobre la firma';
$txt['custom_profile_placement_below_signature'] = 'Bajo la firma';
$txt['custom_profile_placement_below_avatar'] = 'Bajo el avatar';
$txt['custom_profile_placement_above_name'] = 'Sobre el nombre de usuario';
$txt['custom_profile_placement_bottom'] = 'Bajo la información de post';
