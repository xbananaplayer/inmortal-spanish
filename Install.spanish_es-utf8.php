<?php
// Version: Inmortal 1.0 Beta; Install
...
$txt['smf_installer'] = 'Instalador Inmortal';
...
$txt['congratulations_help'] = 'Si en algún momento necesitas soporte, o Inmortal no funciona correctamente, recuerda que <a href="http://www.simplemachines.org/community/index.php" target="_blank">hay ayuda disponible</a> en caso que la necesites.';
...
$txt['good_luck'] = '¡Buena Suerte!<br />K Dev Team';

$txt['install_welcome'] = 'Bienvenido';
$txt['install_welcome_desc'] = 'Bienvenido/a a Inmortal. Este script le guiará a través del proceso para instalar %1$s. Recopilaremos algunos detalles acerca de su foro a lo largo de los siguientes pasos, y después de un par de minutos su foro estará listo para ser usado.';
...
$txt['default_topic_subject'] = '¡Bienvenido a Inmortal!';
$txt['default_topic_message'] = '¡Bienvenido al foro K Dev Team!<br /><br />Esperamos que disfrutes usar tu foro.  Si tienes algún problema, siéntete libre de [url=http://www.simplemachines.org/community/index.php]solicitarnos ayuda[/url].<br /><br />¡Gracias!<br />K Dev Team';
...
$txt['default_news'] = 'Inmortal - ¡Recién Instalado!';
...
$txt['default_fugue_smileyset_name'] = 'Conjunto de Fugue';
$txt['default_theme_name'] = 'Tema por defecto de Inmortal - Curve2';
...
$txt['install_settings_stats_title'] = 'Permitir a K Dev Team recopilar Estadísticas Mensuales Básicas';
$txt['install_settings_stats_info'] = 'Si está activa, permitirá a K Dev Team que visite tu web una vez al mes para recopilar estadísticas básicas. Esto nos ayudará a tomar decisiones acerca de las configuraciones que pueden optimizar el software. Para más información, por favor visita nuestra <a href="http://www.simplemachines.org/about/stats.php" target="_blank">página de información</a> (en inglés).';
...
$txt['db_settings_database_info'] = 'Introduce el nombre de la Base de datos que quieres utilizar para guardar los datos de Inmortal.';
...
$txt['db_settings_database_file_info'] = 'Este es el nombre el archivo en el que se guardarán los datos de Inmortal. Te recomendamos que utilicen un nombre generado aleatoriamente y que establezcas la ruta a este archivo fuera del área pública de tu servidor web.';
...
$txt['error_db_too_low'] = 'La versión de tu servidor de base de datos es muy antigua, y no supera los requerimientos mínimos para utilizar Inmortal.<br /><br />Por favor, solicita a tu proveedor actualizarla o que te proporcione una nueva, si no lo hacen, por favor, prueba en un proveedor diferente.';
$txt['error_db_database'] = 'El instalador no pudo acceder a la base de datos &quot;<em>%1$s</em>&quot;.  En algunos casos, necesitas crear la base de datos en tu panel de administración antes de que Inmortal pueda utilizarlo. Algunos además añaden prefijos (como el usuario) a tus nombres de bases de datos.';
...
$txt['upgrade_upgrade_utility'] = 'Utilidad de actualización de Inmortal';
