<?php
// Version: Inmortal 1.0 Beta; Search
...
$txt['search_create_index_not_ready'] = 'Inmortal está creando actualmente un índice de búsqueda de tus mensajes. Para evitar sobrecargar tu servidor, el proceso ha sido detenido temporalmente. Debería continuar automáticamente en unos pocos segundos. Si no lo hace, por favor haz clic en el enlace de continuar de debajo.';
...
$txt['spider_mode_note'] = 'Ten en cuenta que un seguimiento de más alto nivel incrementa los requerimientos de recursos del servidor.';
