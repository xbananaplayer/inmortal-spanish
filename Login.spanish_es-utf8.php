<?php
// Version: Inmortal 1.0 Beta; Login
...
$txt['agree_coppa_above'] = 'Tengo al menos %1$d años de edad.';
...
$txt['identification_by_smf'] = 'Usado sólo para identificación por Inmortal. Puedes usar caracteres especiales después de haber ingresado, cambiando tu nombre a mostrar en tu perfil.';
...
$txt['login_below_or_register'] = 'Por favor inicia sesión más abajo o <a href="%1$s">registra una cuenta</a> con %2$s ';
...
$txt['coppa_after_registration'] = 'Gracias por registrarte en ' . $context['forum_name_html_safe'] . '.<br><br>Debido a que estás por debajo de los {MINIMUM_AGE} años de edad, es necesario por ley
	que tengas el permiso explícito de tus padres o tutor antes de que puedas empezar a usar tu cuenta. Para continuar con la activación de la cuenta por favor imprime el formulario que a continuación se muestra:';
