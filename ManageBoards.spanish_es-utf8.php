<?php
// Version: Inmortal 1.0 Beta; ManageBoards
...
$txt['mboards_cat_description_desc'] = 'Una descripción breve de tu categoría.';
...
$txt['mboards_moderator_groups_desc'] = 'Grupos cuyos miembros tienen privilegios de moderación en este foro. Ten en cuenta que esto está limitado a grupos que no están basados en número de mensajes y que no están "ocultos".';
